...
export function FileEntryList(props: FileEntryListProps) {
  ...
  return <div className="fm-list" ref={props.listRef} onClick={props.onClearSelection}>
    ...
    {!props.isLoading && props.entries.length === 0 && <div className="fm-empty"><FolderOpen size={40} color="var(--color-black)" /><span>{t('files.empty')}</span><span className="fm-empty-hint">{t('files.emptyHint')}</span></div>}
