...
describe('desktop file actions', () => {
  it('opens the context menu with desktop pointer coordinates', () => {
    ...
    const onGoUp = vi.fn();
    render(<I18nProvider><FileEntryList entries={[entry]} isLoading={false} selectedItem={null} dragOverFolder={null} renamingEntry={null} renameValue="" newItemType={null} newItemName="" showParentEntry isParentDragOver={false} listRef={createRef()} renameInputRef={createRef()} newItemInputRef={createRef()} onClearSelection={vi.fn()} onGoUp={onGoUp} onParentDragOver={vi.fn()} onParentDrop={vi.fn()} onItemClick={vi.fn()} onItemDoubleClick={vi.fn()} onOpenContextMenu={onOpenContextMenu} onTouchStart={vi.fn()} onTouchMove={vi.fn()} onTouchEnd={vi.fn()} onTouchCancel={vi.fn()} onDragStart={vi.fn()} onFolderDragOver={vi.fn()} onFolderDragLeave={vi.fn()} onFolderDrop={vi.fn()} onRenameChange={vi.fn()} onRenameConfirm={vi.fn()} onRenameCancel={vi.fn()} onNewNameChange={vi.fn()} onNewConfirm={vi.fn()} onNewCancel={vi.fn()} /></I18nProvider>);
