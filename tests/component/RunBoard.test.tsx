...
const interruptedRun: AgentRun = {
  ...
  task: { objective: 'work', acceptanceCriteria: [], constraints: [], requiresPlan: true, plan: [{ id: 'one', title: 'Inspect the dumpster fire', status: 'completed' }], evidence: [], changedWorkspace: true, verified: true },
...
describe('RunBoard', () => {
  it('surfaces an interrupted Run, proof state, and checkpoint resume action', async () => {
    ...
    expect(screen.getByText('Sunam 任务战情室')).toBeInTheDocument();
